...
class Config:
    ...
    POSE_VIDEO_DEMO4_URL = os.getenv('POSE_VIDEO_DEMO4_URL')
    TARGET_VIDEO_DEMO4_URL = os.getenv('TARGET_VIDEO_DEMO4_URL')
    POSE_VIDEO_DEMO5_URL = os.getenv('POSE_VIDEO_DEMO5_URL')
    TARGET_VIDEO_DEMO5_URL = os.getenv('TARGET_VIDEO_DEMO5_URL')
    POSE_VIDEO_DEMO6_URL = os.getenv('POSE_VIDEO_DEMO6_URL')
    TARGET_VIDEO_DEMO6_URL = os.getenv('TARGET_VIDEO_DEMO6_URL')
    POSE_VIDEO_DEMO7_URL = os.getenv('POSE_VIDEO_DEMO7_URL')
    TARGET_VIDEO_DEMO7_URL = os.getenv('TARGET_VIDEO_DEMO7_URL')
    POSE_VIDEO_DEMO8_URL = os.getenv('POSE_VIDEO_DEMO8_URL')
    TARGET_VIDEO_DEMO8_URL = os.getenv('TARGET_VIDEO_DEMO8_URL')
